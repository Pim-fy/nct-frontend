  ...
  return (
    <div className="absolute contents left-[440px] top-[141px]" data-name="CONTENTS">
      ...
      <form onSubmit={handleSave}>
        ...
        {/* 프로필 사진 */}
        <div className="absolute left-[499px] top-[218px] size-[86px] rounded-full overflow-hidden bg-[#e6f0ff]">
      ...
      <img src={assets.loginIcon} alt="구글/네이버/카카오" className="absolute left-[1481px] top-[215px] h-[60px] w-[248px] object-contain" />
      {[
      ...
      {[
        ...
        <React.Fragment key={row.key}>
          <button
            ...
            className="absolute size-[16px] rounded-[2px] border border-[#d9d9d9] bg-white flex items-center justify-center cursor-pointer overflow-hidden"
            style={{ left: 1561, top: row.top }}
            aria-label={`${row.key} 인앱 알림`}
          >
            {notify[row.key].inapp && <img src={assets.checkOn} alt="" className="size-full object-cover" />}
          </button>
          <button
            type="button"
          ...
          >
            {notify[row.key].email && <img src={assets.checkOn} alt="" className="size-full object-cover" />}
          </button>
        </React.Fragment>
      ))}
    </div>
