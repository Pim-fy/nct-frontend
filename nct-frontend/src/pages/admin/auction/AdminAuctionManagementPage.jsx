 ...
 */
const SAMPLE_ROWS = [
  { id: 'AUC-104', product: '캠핑 의자 세트', seller: '김민수', productStatus: '판매중', auctionStatus: '진행중', auctionStatusCode: 'AUCC0002', bidStatus: '입찰 4건', tradeStatus: '-', date: '2026-07-19' },
  { id: 'AUC-103', product: '태블릿 11인치', seller: '이서연', productStatus: '낙찰', auctionStatus: '종료', auctionStatusCode: 'AUCC0003', bidStatus: '입찰 7건', tradeStatus: '거래대기', date: '2026-07-18' },
  { id: 'AUC-102', tradeSn: 102, product: '원목 책상', seller: '박준호', productStatus: '거래중', auctionStatus: '취소요청', auctionStatusCode: 'AUCC0006', bidStatus: '입찰 2건', tradeStatus: '거래중', date: '2026-07-17', cancellation: { requestedAt: '2026-07-18 10:30', reason: '낙찰자와 배송 일정 조율이 어려워 거래 취소를 요청합니다.', previousAuctionStatus: '종료', previousAuctionStatusCode: 'AUCC0003' } },
];

const tone = (value) => ({ 진행중: 'info', 낙찰: 'warning', 거래중: 'info', 판매완료: 'success', 완료: 'success', 거래대기: 'warning', 배송중: 'info', 종료: 'neutral', 취소요청: 'danger', 취소: 'danger' }[value] ?? 'neutral');
