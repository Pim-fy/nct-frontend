...
const formatRemainingTime = (endDateTime, statusCode, statusName) => {
...
const AuctionCard = ({ item }) => {
  ...
  const remainingTime = formatRemainingTime(item.endDateTime, item.auctionStatusCode, item.auctionStatusName);
