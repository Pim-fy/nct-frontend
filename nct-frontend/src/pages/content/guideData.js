...
export const GUIDE_FLOWS = [
  ...
  },
  {
    ...
    journey: 'service',
    title: '서비스 요청',
    summary: '이사·청소 등 필요한 분야와 세부 질문에 답해 요청서를 공개합니다.',
    flowTitle: '서비스 요청 흐름',
  ...
  },
  {
    ...
    journey: 'service',
    title: '견적 비교·선택',
    summary: '제공자가 제출한 견적을 금액과 내용으로 비교한 뒤 하나를 선택합니다.',
    flowTitle: '견적 선택 흐름',
    flowCopy: '견적을 선택하면 견적 거래와 보관금이 함께 생성되고 채팅방으로 이어집니다.',
    preview: { type: 'quote-selection' },
  },
  {
    id: 'auction-bid',
    order: 4,
...
export const GUIDE_JOURNEYS = [
  ...
  },
  {
    ...
    flowIds: ['service-request', 'quote-selection', 'trade-completion', 'point-settlement'],
    ctaLabel: '견적 요청하기',
