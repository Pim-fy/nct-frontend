      ...
      <div className="container py-10">
        <div className="flex flex-wrap items-start justify-between gap-8">
          ...
          <div className="flex flex-col gap-4">
            <span className="text-[20px] font-black tracking-[-1px] text-white">에누리컷</span>

            <nav className="flex flex-wrap gap-x-6 gap-y-2 text-[15px] tracking-[-0.5px]">
            ...
            <p className="text-[13px] leading-[1.6] text-white/50 max-w-[720px]">
          ...
          <div className="flex flex-col items-start md:items-end gap-1 shrink-0">
            <a href="tel:070-1234-5678" className="text-[28px] md:text-[36px] font-bold tracking-[-1px] text-white hover:text-primary-light transition-colors">
              070.1234.5678
            </a>
            <p className="text-[14px] text-white/50 text-left md:text-right">
              평일 10:00 - 18:00
              <br />
